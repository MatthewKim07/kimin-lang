...
![Tests](https://img.shields.io/badge/tests-4337_passing-4caf50?style=flat-square)
...
![Milestone](https://img.shields.io/badge/milestone-18A-informational?style=flat-square)
...
This is a from-scratch implementation: hand-written lexer, recursive-descent parser, static type checker, tree-walk interpreter, bytecode compiler, and stack-based VM — all in Rust, ~15k lines, **4337 tests passing**.
