...
![Tests](https://img.shields.io/badge/tests-4062_passing-4caf50?style=flat-square)
...
![Milestone](https://img.shields.io/badge/milestone-17B-informational?style=flat-square)
...
This is a from-scratch implementation: hand-written lexer, recursive-descent parser, static type checker, tree-walk interpreter, bytecode compiler, and stack-based VM — all in Rust, ~15k lines, **4062 tests passing**.
